...
const Head = ({ toggleSidebar }) => {
  ...
  return (
    <header className="bg-white sticky top-0 flex flex-row gap-2 justify-between border-b border-slate-200 px-2 md:px-4 py-2">
      <div className="flex flex-row items-center gap-2 text-gray-400">
        <div className="flex flex-row items-center gap-2 text-gray-400">
          <button
            onClick={toggleSidebar}
            className="p-2 rounded hover:bg-gray-100 hover:text-gray-600 transition"
          >
            <Menu size={22} />
          </button>
