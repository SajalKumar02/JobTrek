    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 bg-opacity-40">
      <div className="relative bg-white rounded shadow-lg max-w-2xl w-full mx-4 max-h-[95vh] overflow-y-auto">
        ...
        <form className="p-6" onSubmit={handleSubmit}>
          ...
          {/* Program Information */}
          <div className="mb-4">
            <label className="block mb-1 font-medium">Program Highlights *</label>
            <input
              type="text"
          ...
          {/* CheckBoxes - hasBonus, hasBenefits, isListingActive */}
          <div className="mb-4 flex gap-4">
          ...
          {/* Listing Status */}
          <div className="mb-4">
            <label className="block mb-1 font-medium">Job Posting URL *</label>
            <input
              type="text"
              name="jobPostingURL"
          ...
          <div className="mb-4">
            <label className="block mb-1 font-medium">Job Source *</label>
            <input
              type="text"
              name="jobSource"
